...
const LANG = {
  en: {
    ...
    contact_title:  'Tell more about your project',
    form_email:     'EMAIL',
  ...
  ru: {
    ...
    srv1_desc:      'Создание работающих систем и сервисов на базе ИИ под конкретный запрос или задачу.',
    srv2_title:     'ВНЕДРЕНИЕ',
    srv2_desc:      'Внедрение продуктов и ИИ решений в существующие бизнес-процессы и workflow.',
    srv3_title:     'ОБУЧЕНИЕ',
    srv3_desc:      'Обучение и консультация по всем аспектам ИИ и адаптации бизнеса под его внедрение.',
    srv4_title:     'ПОДДЕРЖКА',
    srv4_desc:      'Поддержка и сопровождение созданных решений в первые месяцы после внедрения и дольше при необходимости.',
